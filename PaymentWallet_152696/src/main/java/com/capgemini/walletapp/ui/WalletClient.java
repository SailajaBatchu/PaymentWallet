...
import com.capgemini.walletapp.exception.MinTransferAmountException;
import com.capgemini.walletapp.service.WalletAppService;
import com.capgemini.walletapp.service.WalletValidation;
...
public class WalletClient {
	...
	public static void main(String[] args) {
		...
		System.out.println("\t*****Welcome to XYZ Service******");
	...
	public static void createAccount() {
		...
		try {
			...
			// Validation of input
			WalletValidation validate = new WalletValidation();
	...
	public static void extendedMenu(WalletAppDetails details) {
